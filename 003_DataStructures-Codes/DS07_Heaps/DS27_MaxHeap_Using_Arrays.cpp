...
class MaxHeap{
    public:
        int arr[100];
        int Size;
        MaxHeap(void){ //Constructor Of Class Heap.....
            this->Size=(-1);    
        }  
        ...
        void Heapify(int i) { // O(Logn).....
            ...
            if (MaxIDX != i) {  //When The Value Of Child Is Greater Than The Parent Value.....
                int temp = arr[i];  // Swap arr[i] & arr[MaxIDX]......
                arr[i] = arr[MaxIDX];
                arr[MaxIDX]=temp;
        ...
        int Remove() { // O(Logn).....
            ...
            // Step-3 ::: Heapify To Mantain/Fix The MaxHeap.....
            Heapify(0);
...
int main(){
    ...
    heap.PrintArray();
    cout<<"PEEK OF MAX HEAP IS ::: "<<heap.Peek_MaxHeap()<<endl;
    heap.Remove();
